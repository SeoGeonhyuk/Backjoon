...
//     answerLength += i;
//   }
//   let roundNumber = n * 3 - 3;
//   let inSideNumber = roundNumber + 1;
//   let nextLength = 1;
//   let startNumber = 1;
//   while (answer.length < answerLength) {
//     const stageAnswer = [];
//     stageAnswer.push(startNumber);
//     startNumber += 1;
//     const stageAnswerLength = stageAnswer.length;
//     if(nextLength < n){
//         for (let i = 0; i < nextLength - stageAnswerLength- 1; i++) {
//             stageAnswer.push(inSideNumber);
//             inSideNumber += 1;
//           }
//     }
//     else {
...
//         }
//     }
//     if(stageAnswer.length !== nextLength) {
//         stageAnswer.push(roundNumber);
//         roundNumber -= 1;
//     }
//     answer.push(...stageAnswer);
